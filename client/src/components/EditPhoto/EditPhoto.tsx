...
function resample_single(canvas: { width: any; height: any; getContext: (arg0: string) => any; }, width: number, height: number, resize_canvas: boolean) {
...
export default function EditPhoto(){
    ...
    React.useEffect(() => {
        ...
        reader.addEventListener('load', () => {
            ...
            resample_single(canvasRef.current, width, height, true);
