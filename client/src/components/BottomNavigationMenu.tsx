...
function BottomNavigationMenu() {
    ...
    const onChangePhotoUploadInputRef = async (e:React.ChangeEvent<HTMLInputElement>) => {
        await dispatch(photoUpload(e.target.files![0]))  
...
export default React.memo(BottomNavigationMenu);