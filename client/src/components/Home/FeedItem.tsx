...
interface PropsFeedItem{
    username: string,
    img: string
}

export default function FeedItem(props:PropsFeedItem) {
    const {username,img} = props;
    return (
        <div className="home__feed__item">
