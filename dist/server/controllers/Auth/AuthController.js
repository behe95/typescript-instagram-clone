            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 9:
                        ...
                        authToken = jsonwebtoken_1.default.sign(payload, process.env.JWT__AUTH__TOKEN__SECRET, {
                            algorithm: 'HS256',
                            expiresIn: '3600s'
                        });
                        refreshToken = jsonwebtoken_1.default.sign(payload, process.env.JWT__REFRESH__TOKEN__SECRET, { algorithm: 'HS256' });
