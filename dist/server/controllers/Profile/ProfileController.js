...
var ProfileController = /** @class */ (function () {
    function ProfileController() {
        ...
        this.uploadPhotoController = function (request, respone) { return __awaiter(_this, void 0, void 0, function () {
            var firestore, bucket, file, caption, userId;
            var _this = this;
            return __generator(this, function (_a) {
                firestore = request.firestore;
                bucket = request.storage.bucket(process.env.CLOUD__STORAGE__BUCKET__NAME);
                ...
                userId = request.user._id;
                UploadFile_1.default(file, bucket).then(function (uploadedImageInfo) { return __awaiter(_this, void 0, void 0, function () {
                    var docRef, defaultData, data;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                docRef = firestore.collection('photos').doc();
                                defaultData = {
                                    _id: docRef.id,
                                    userId: userId
                                };
                                return [4 /*yield*/, docRef.set(__assign(__assign({}, uploadedImageInfo), defaultData))];
                            case 1:
                                data = _a.sent();
                                ...
                                respone.status(200).send({
                                    ...
                                    data: __assign(__assign({}, defaultData), uploadedImageInfo)
                                });
                                return [2 /*return*/];
                        }
                    });
        ...
        this.getAllPhotosController = function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            var firestore, photos, photosSnapshot, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        firestore = request.firestore;
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, firestore.collection('photos').where("userId", "==", request.user._id).get()];
                    case 2:
                        photosSnapshot = _a.sent();
                        // const userData = userSnapshot.data();
                        // delete userData.password;
                        // delete userData.refreshToken;
                        if (photosSnapshot.docs.length > 0) {
                            photosSnapshot.forEach(function (snapshot) {
                                photos.push(snapshot.data());
                            });
                        }
                        response.status(200).send({ photos: photos });
                        return [3 /*break*/, 4];
                    case 3:
                        error_3 = _a.sent();
                        console.log(error_3);
    ...
    ProfileController.prototype.initializeRoutes = function () {
        ...
        this.router.post(this.path + "/uploadPhoto", auth_middleware_1.default, multer_middleware_1.default(), this.uploadPhotoController);
        this.router.get(this.path + "/getAllPhotos", auth_middleware_1.default, this.getAllPhotosController);
    };
