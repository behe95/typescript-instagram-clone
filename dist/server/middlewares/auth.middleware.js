...
function authMiddleware(request, respone, next) {
    return __awaiter(this, void 0, void 0, function () {
        var cookies, JWT__AUTH__TOKEN__SECRET, userSnapshots, verificationResponse, _id, firestore, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    cookies = request.cookies;
                    if (!(cookies && cookies.JWT__AUTH__TOKEN)) return [3 /*break*/, 5];
                    JWT__AUTH__TOKEN__SECRET = process.env.JWT__AUTH__TOKEN__SECRET;
                    userSnapshots = void 0;
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    verificationResponse = jsonwebtoken_1.default.verify(cookies.JWT__AUTH__TOKEN, JWT__AUTH__TOKEN__SECRET);
                    console.log(verificationResponse);
                    _id = verificationResponse._id;
                    firestore = request.firestore;
                    return [4 /*yield*/, firestore.collection('users').where('_id', '==', _id).get()];
                case 2:
                ...
                case 3:
                    error_1 = _a.sent();
                    console.log("WrongAuthenticationTokenException =========================== 2", error_1);
                    next(new WrongAuthenticationTokenException_1.default());
                    return [3 /*break*/, 4];
