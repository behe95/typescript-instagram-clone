...
var AuthProvider = function (_a) {
    ...
    var _b = react_1.default.useState(false), authContextIsLoading = _b[0], setAuthContextIsLoading = _b[1];
    var _c = react_1.default.useState(function () { return js_cookie_1.default.get('JWT__AUTH__TOKEN') ? true : false; }), isAuthenticated = _c[0], setIsAuthenticated = _c[1];
    var _d = react_1.default.useState({ profilePhoto: { url: '/static/images/portrait/portrait1.jfif' } }), userInfo = _d[0], setUserInfo = _d[1];
