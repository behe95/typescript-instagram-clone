...
exports.Post = Post;
function Posts() {
    return (jsx_runtime_1.jsx("div", __assign({ className: "profile__posts__container" }, { children: jsx_runtime_1.jsx("div", __assign({ className: "row no-gutters" }, { children: data.map(function (d, key) { return (jsx_runtime_1.jsx(Post, { number: key, src: d.img }, key)); }) }), void 0) }), void 0));
}
