...
function UserInfoAndActions() {
    var _a = react_1.default.useState({}), info = _a[0], setInfo = _a[1];
    var _b = Auth_context_1.useAuth(), setIsAuthenticated = _b.setIsAuthenticated, userInfo = _b.userInfo;
    ...
    return (jsx_runtime_1.jsxs(jsx_runtime_1.Fragment, { children: [jsx_runtime_1.jsx(Header_1.default, { info: info }, void 0),
