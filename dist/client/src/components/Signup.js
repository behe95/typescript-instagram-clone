...
function Signup() {
    ...
    var onclickSignup = function () {
        ...
        if (formValidators_1.validateNumber(user)) {
            axios_1.default
                .post('/api/auth/register', __assign(__assign({}, data), { registeredUsing: "phone" }))
                .then(function (res) {
                console.log(res);
            }).catch(function (err) {
                // const {data} = err.response;
            ...
            axios_1.default
                .post('/api/auth/register', __assign(__assign({}, data), { registeredUsing: "email" }))
                .then(function (res) {
                console.log(res);
            }).catch(function (err) {
                // const {data} = err.response;
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ id: "signup__component" }, { children: [jsx_runtime_1.jsxs("div", __assign({ className: "signup__component__header" }, { children: [jsx_runtime_1.jsx("img", { className: "instagram__logo__text__image", src: "/static/images/instagram-logo-text.png", alt: "instagram-logo-text" }, void 0),
            ...
            jsx_runtime_1.jsxs("div", __assign({ className: "bottom" }, { children: [jsx_runtime_1.jsx("button", __assign({ onClick: function () { return onclickSignup(); }, className: "btn btn-primary btn-sm " + (!isValid ? 'disabled' : '') + " login__button" }, { children: "Sign up" }), void 0),
